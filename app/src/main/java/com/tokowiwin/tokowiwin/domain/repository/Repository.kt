...
interface Repository {
    ...
    fun insertTransaction(id: Long, userId: Int, receiverName: String, receiverPhone: String, receiverAddress: String, paymentType: String) : LiveData<InsertTransactionResponse>
